...
- la lista degli utenti diversi che compaiono nella lista di log
- la lista degli eventi diversi che compaiono nella lista di log;
- per ogni evento diverso quanti eventi sono presenti nella lista di log.
